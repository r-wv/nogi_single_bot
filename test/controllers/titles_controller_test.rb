...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { center: @title.center, name: @title.name, release: @title.release } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { center: @title.center, name: @title.name, release: @title.release } }
